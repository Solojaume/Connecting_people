...
use app\commands\SocketIOSustituto;
...
{
    public $authenable = false;//en los controladores que no queramos el token se pone en false
    ...
    { 
        ...
        echo "port";
        var_dump($port);
        $host = "localhost"??$GLOBALS["base_socket_io_host"];
        echo "host";
        var_dump($host);
